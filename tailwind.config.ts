...
export default {
	...
	theme: {
		extend: {
			...
			backgroundImage: {
				'hero-radial':  'radial-gradient(ellipse 90% 70% at 50% -10%, rgba(0,51,153,0.55) 0%, transparent 70%)',
				'mesh-radial':  'radial-gradient(ellipse 70% 60% at 15% 50%, rgba(0,40,120,0.22) 0%, transparent 65%)',
