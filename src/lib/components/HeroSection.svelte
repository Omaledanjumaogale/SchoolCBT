      ...
      <div>
        ...
        <div class="flex flex-wrap items-center gap-4 text-xs text-white/35">
          <div class="flex -space-x-2">
            {#each ['AO','CK','EM','TJ'] as init, i}
              <div class="avatar h-7 w-7 border-2 border-cobalt-xdark text-white {['bg-cobalt-light/60','bg-jade/40','bg-gold/40','bg-scarlet/40'][i]}">{init}</div>
            {/each}
